...
$.extend( Datepicker.prototype, {
	...
	_generateMonthYearHeader: function( inst, drawMonth, drawYear, minDate, maxDate,
		...
		if ( secondary || !changeMonth ) {
			...
			monthHtml += "<select class='ui-datepicker-month form-select select-month' aria-label='" + selectMonthLabel + "' data-handler='selectMonth' data-event='change'>";
		...
		if ( !inst.yearshtml ) {
			...
			if ( secondary || !changeYear ) {
				...
				inst.yearshtml += "<select class='ui-datepicker-year form-select select-year' aria-label='" + selectYearLabel + "' data-handler='selectYear' data-event='change'>";
